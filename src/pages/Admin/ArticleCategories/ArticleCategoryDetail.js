...
const ArticleCategoryReview = (props) => {
...
function ArticleCategoryDetail(props) {
  ...
  document.title = "ArticleCategory Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="ArticleCategory Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      <div className="d-flex">
                        ...
                        <div className="flex-shrink-0">
                          <div>
                            ...
                            <a
                              href={"/admin-add-ArticleCategory/"+id}
                              id="TooltipTop"
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">ArticleCategory Description :</h5>
