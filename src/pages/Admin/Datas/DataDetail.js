...
function DataDetail(props) {
  ...
  document.title = "Data Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="Data Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Data Description :</h5>
                            ...
                            <div className="table-responsive">
                              <table className="table mb-0">
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row">Prediction_date</th>
                                    <td>{Data.prediction_date}</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Datacol</th>
                                    <td>{Data.datacol}</td>
                                  </tr>
                                  <tr>
