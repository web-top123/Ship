                  ...
                  <React.Fragment key={key}>
                    <Link to="#" className="d-block">
                      <img
                        src={subItem.img}
                        alt=""
                        className="productData-sm rounded object-cover"
                      />
                    </Link>
                  </React.Fragment>
                ))}
      ...
      <Col lg={3} sm={6}>
        <div className="p-2 border border-dashed rounded">
          <div className="d-flex align-items-center">
            <div className="productData-sm me-2">
              <div className="productData-title rounded bg-transparent text-success fs-24">
...
function ProductDataDetail(props) {
  ...
  const [ProductDataSrc, setProductDataSrc] = useState({
  });
  useEffect(() => {
    if (id) {
  ...
  document.title = "ProductData Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="ProductData Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">ProductData Description :</h5>
