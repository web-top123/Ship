...
function ArticleDetail(props) {
  ...
  document.title = "Article Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="Article Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Article Description :</h5>
                            ...
                            <div className="table-responsive">
                              <table className="table mb-0">
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row">ArticleCategoryId</th>
                                  ...
                                  <tr>
                                    <th scope="row">Oppositions</th>
                                    <td>{Article.oppositions}</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Browingcount</th>
                                    <td>{Article.browingcount}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
