...
import { addNewMedia, getMedia, updateOneMedia, downloadMedia } from "../../../helpers/fakebackend_helper";
                  ...
                  <React.Fragment key={key}>
                    <Link to="#" className="d-block">
                      <img
                        src={subItem.img}
                        alt=""
                        className="media-sm rounded object-cover"
                      />
                    </Link>
                  </React.Fragment>
                ))}
        ...
        <div className="p-2 border border-dashed rounded">
          <div className="d-flex align-items-center">
            <div className="media-sm me-2">
              <div className="media-title rounded bg-transparent text-success fs-24">
...
function MediaDetail(props) {
  ...
  useEffect(() => {
    if (id) {
      ...
      setMediaSrc(downloadMedia(id));
      console.log(downloadMedia(id));
    }
  }, []);
  ...
  document.title = "Media Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="Media Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Media Description :</h5>
