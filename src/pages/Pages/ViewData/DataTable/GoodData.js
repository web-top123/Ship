...
const GoodData = () => {
            ...
            <Button 
                ...
                onClick={() => { 
                    if (!myInformationSelector) {
                        ...
                        tog_togFirst(); 
                        setGoodData({ categoryId: 4, userId: myInformationSelector.id, username: myInformationSelector.username, dataId: e.id, dataname: e.name, voterId: e.voterId });
                    }
                 }}
            >
    ...
    return (
        <React.Fragment>
            <TabPane tabId="4" id="v-pills-good">
