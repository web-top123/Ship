...
const ShipData = () => {
    const columns = useMemo(() => columnsShipData, []);
    ...
    return (
        <React.Fragment>
            <TabPane tabId="1" id="v-pills-ship">
        ...
        >
            ...
            <div className="mt-4 pt-3 pb-3">
                ...
                <NavLink href="view-data" className=' d-inline'>
                    <Button color="primary" className="ms-3" href = {"/ship-details/" + shipData.dataId}  onClick={() => tog_togSecond(false)}>Yes</Button>
                </NavLink>
