...
import { addNewData, getProductData, updateOneData } from "../../../../helpers/fakebackend_helper";
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Details of Product :</h5>                        
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Properities of Product :</h5>                        
                        <div className="table-responsive">
                          <table className="table mb-0">
                            <tbody>
                              <tr>
