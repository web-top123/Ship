...
function ProgramDetail(props) {
  ...
  document.title = "Program Details | Velzon - React Admin & Dashboard Template";
  return (
    <div className="page-content">
      <Container fluid>

        <BreadCrumb title="Program Details" pageTitle="Ecommerce" />
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="product-content mt-5">
                        <h5 className="fs-14 mb-3">Program Description :</h5>
                            ...
                            <div className="table-responsive">
                              <table className="table mb-0">
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row">ProgramCategoryId</th>
                                    <td>{Program.programCategoryId}</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>{Program.purchases}</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Recommends</th>
                                    <td>{Program.recommends}</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">File_url</th>
                                    <td>{Program.file_url}</td>
                                  </tr>
                                  <tr>
